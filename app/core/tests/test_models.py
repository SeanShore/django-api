...
def sample_user(email="test@shoremonitoring.nl", password="testpass123"):
    """ Create sample user"""
...
class ModelTest(TestCase):
    ...
    def test_recipe_to_str(self):
        """ Test the recipe string representatie"""
